...
const flame = { seatX: 744, seatY: 640, sourceWidth: 54, fps: 10.2 } as const;
...
export function RunesCandleFlame({ geometry }: { geometry: RunesGeometry }) {
  const reportError = useCallback((error: Error) => {
    console.error("[Runes/Flame] Failed to load atlas", error);
  }, []);
